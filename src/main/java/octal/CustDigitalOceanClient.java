...
public class CustDigitalOceanClient implements DigitalOcean, Constants {
	private static final Logger log = LoggerFactory.getLogger(DigitalOceanClient.class);
	   ...
	   */
	  public CustDigitalOceanClient(String authToken) {
	    this("v2", authToken);
	  }
	   ...
	   * @param authToken a {@link String} object
	   */
	  public CustDigitalOceanClient(String apiVersion, String authToken) {
	   ...
	   */
	  public CustDigitalOceanClient(String apiVersion, String authToken, CloseableHttpClient httpClient) {
	  ...
	  public Regions getAvailableRegions(Integer pageNo)
	      throws DigitalOceanException, RequestUnsuccessfulException {
	    validatePageNo(pageNo);
	    return (Regions) perform(new ApiRequest(ApiAction.AVAILABLE_REGIONS, pageNo, 50))
	        .getData();
	  }
	  ...
	  public Sizes getAvailableSizes(Integer pageNo)
	      throws DigitalOceanException, RequestUnsuccessfulException {
	    validatePageNo(pageNo);
	    return (Sizes) perform(new ApiRequest(ApiAction.AVAILABLE_SIZES, pageNo, 75))
	        .getData();
	  }
